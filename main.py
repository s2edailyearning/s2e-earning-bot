...
def main():
    ...
    while retry_count < max_retries:
        ...
        try:
            ...
            # FIX: Register the Upload Screenshot button callback.
            # The button sends daily_upload_screenshot; without this handler Telegram
            # receives the callback but the bot has nothing to execute.
